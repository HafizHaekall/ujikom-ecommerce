    ...
    @csrf
        <div class="flex gap-8 items-start px-4 mx-auto max-w-screen-xl lg:px-6">
            <div class="">
                ...
                <input type="file" id="photo" name="photo" class="relative w-60 mt-4 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help">
