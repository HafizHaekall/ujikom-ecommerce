    ...
    @csrf
        <div class="flex gap-8 items-start px-4 mx-auto max-w-screen-xl lg:px-6">
            <div class="">
                ...
                <input type="file" id="photo" name="photo" class="relative w-60 mt-4 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50ocus:outline-none" aria-describedby="file_input_help">
            ...
            <div class="flex mt-4 md:mt-0">
                <div class="flex flex-col items-center justify-start px-6 mx-auto ">
                    <div class="w-[1000px] h-[440px] bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
