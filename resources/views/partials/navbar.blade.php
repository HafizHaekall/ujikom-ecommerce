    ...
    <div class="flex items-center md:order-1">
        <form action="" method="">
            ...
            <div class="relative hidden md:block">
                ...
                <input type="text" name="query" id="search-navbar" value="{{ request('query')}}" @if(!request()->is('home')) disabled @endif class="block w-[50vw] p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari Produk...">
            </div>
        </form>
        ...
        <div id="tooltip-bottom" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip">
            Keranjang
            <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        <button data-collapse-toggle="navbar-search" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-search" aria-expanded="false">
