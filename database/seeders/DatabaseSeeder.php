...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = [
            ['products/pin.jpg', 'Pin', 'Tambahkan sedikit kilauan pada pakaian Anda dengan Pin kami!  Dengan berbagai desain yang unik, pin ini adalah aksesoris yang serbaguna dan bisa Anda kenakan dengan bangga di mana saja. Tampilkan gaya Anda! 📌', 5000, 50],
            ...
            ['products/tb_hitam.jpg', 'Totebag hitam desain 1/2', 'Totebag Hitam Desain 1/2 kami adalah paduan antara gaya klasik dan sentuhan modern. Terbuat dari bahan berkualitas tinggi, totebag ini menjadi pilihan yang tepat untuk tampil berbeda. Dengan desain uniknya, totebag ini cocok untuk segala aktivitas Anda. ', 30000, 50],
        ];
